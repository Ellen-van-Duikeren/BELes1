...
public class MediorOne {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(doubledResult + " gekwadratteerd is: " + kwadrNumber(doubledResult));
    }
    ...
    public static int kwadrNumber(int doubledResult) {
        return doubledResult * doubledResult;
    }
}
